...
TOOLS = {
    "check_azure_monitor": {
        "lambda": "sigma-tool-check-azure-monitor",
        "description": "Check Azure Monitor and CloudWatch metrics for function errors, Event Hub delivery failures, throttles, and deployment history.",
        "parameters": {
    ...
    "get_eventhub_records": {
        "lambda": "sigma-tool-get-eventhub-records",
        "description": "Replay records from Event Hub from a given timestamp with field remapping applied.",
        "parameters": {
    ...
    "rollback_function_deployment": {
        "lambda": "sigma-tool-rollback-function",
        "description": "Roll back an Azure Function or Lambda to the previous stable deployment version and verify with test records.",
        "parameters": {
            "function_name": {"description": "Function name", "required": True, "type": "string"},
            "alias_name": {"description": "Alias to update, e.g. LIVE", "required": True, "type": "string"},
            "target_version": {"description": "Version to roll back to, or 'previous' for auto-detect", "required": True, "type": "string"},
        },
    },
    "create_alert": {
        "lambda": "sigma-tool-create-alert",
        "description": "Create a CloudWatch alarm to monitor the data pipeline.",
        "parameters": {
            "alert_type": {"description": "Alert template: zero_snowflake_load | lambda_version_change | pipeline_row_divergence", "required": True, "type": "string"},
            "custom_name": {"description": "Custom alarm name (optional)", "required": False, "type": "string"},
            "custom_description": {"description": "Custom alarm description (optional)", "required": False, "type": "string"},
        },
    },
    "quarantine_rows": {
...
AGENT_TOOLS = {
    "ForensicsAgent":      ["check_azure_monitor", "query_snowflake"],
    "ImpactAgent":         ["query_snowflake"],
    "RecoveryAgent":       ["get_eventhub_records", "query_snowflake", "quarantine_rows", "load_to_snowflake"],
    "RollbackAgent":       ["rollback_function_deployment", "send_sns_alert"],
    "HardeningAgent":      ["create_alert", "send_sns_alert"],
...
TOOL_MAP = {
    "check_azure_monitor":         "sigma-tool-check-azure-monitor",
    "query_snowflake":             "sigma-tool-query-snowflake",
    "get_eventhub_records":        "sigma-tool-get-eventhub-records",
    "rollback_function_deployment": "sigma-tool-rollback-function",
    "create_alert":                "sigma-tool-create-alert",
